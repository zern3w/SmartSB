    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Register school bus driver</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        {{ csrf_field() }}

                        <div class="form-group{{ $errors->has('driver_firstname') ? ' has-error' : '' }}">
                            <label for="driver_firstname" class="col-md-4 control-label">First name</label>

                            <div class="col-md-6">
                                <input id="driver_firstname" type="text" class="form-control" name="driver_firstname"  value="{{ old('driver_firstname') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('driver_lastname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="driver_lastname" type="text" class="form-control" name="driver_lastname"  value="{{ old('driver_lastname') }}" required autofocus>
