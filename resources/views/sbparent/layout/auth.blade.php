    ...
    <nav class="navbar navbar-default navbar-static-top navbar-inverse">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- Branding Image -->
                <a class="navbar-brand" href="{{ url('/sbparent') }}">
                    {{ config('app.name', 'Laravel Multi Auth Guard') }}: Sbparent
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        <li><a href="{{ url('/sbparent/login') }}">Login</a></li>
                        <li><a href="{{ url('/sbparent/register') }}">Register</a></li>
                    @else
                        <li class="dropdown">
                                <a href="#" class="dropdown-toggle" class="navbar-brand"  data-toggle="dropdown" role="button" aria-expanded="false" style="position:relative; padding-left:50px;">
                                   ...
                                   {{ Auth::user()->parent_firstname. ' ' . Auth::user()->parent_lastname}} <span class="caret"></span>
                               </a>
